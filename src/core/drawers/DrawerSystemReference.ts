...
const GAVETA_SETTINGS_RULES: DrawerRuleEntry[] = [
  ...
  },
  {
    ...
    sourceFile: "src/core/drawers/DrawerParametrics.ts",
    status: "legacy",
    notes: "Substituído por gavetaPercentualReducaoLaterais / gavetaPercentualReducaoCosta",
  },
  {
    id: "percentual-laterais",
    label: "Percentual altura laterais (face à frente)",
    value: String(settingsDefaults.gavetas.gavetaPercentualReducaoLaterais),
    formula: "sideH = frontH × gavetaPercentualReducaoLaterais",
    sourceFile: "src/core/drawers/drawerSolidWorksStackGeometry.ts",
    status: "official",
    notes: "Admin → Dimensões e Parametrização",
  },
  {
    id: "percentual-costa",
    label: "Percentual altura costa (face às laterais)",
    value: String(settingsDefaults.gavetas.gavetaPercentualReducaoCosta),
    formula: "backH = sideH × gavetaPercentualReducaoCosta",
    sourceFile: "src/core/drawers/DrawerParametrics.ts",
    status: "official",
    notes: "Admin → Dimensões e Parametrização",
  },
