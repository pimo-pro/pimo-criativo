/**
 * Modelo 3D: Superior de Cozinha 25cm profundidade - 70cm largura
 * Categoria: Cozinha - Superior
 * Descrição: Caixa superior de cozinha com profundidade de 25cm e largura fixa de 70cm
 * 
 * Estrutura:
 * - Laterais: 72cm altura x 25cm profundidade
 * - Base: 70cm largura x 25cm profundidade
 * - Topo: 70cm largura x 25cm profundidade
...
// Metadados do modelo
const metadata = {
  name: "Superior de Cozinha 25d - 70cm",
  category: "cozinha_superior",
  description: "Caixa superior de cozinha com profundidade de 25cm e largura fixa de 70cm",
  dimensions: {
    width: 700,  // mm
    height: 720, // mm
    depth: 250   // mm
