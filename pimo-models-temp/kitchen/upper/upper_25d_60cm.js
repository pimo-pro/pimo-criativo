/**
 * Modelo 3D: Superior de Cozinha 25cm profundidade - 60cm largura
 * Categoria: Cozinha - Superior
 * Descrição: Caixa superior de cozinha com profundidade de 25cm e largura fixa de 60cm
 * 
 * Estrutura:
 * - Laterais: 72cm altura x 25cm profundidade
 * - Base: 60cm largura x 25cm profundidade
 * - Topo: 60cm largura x 25cm profundidade
...
// Metadados do modelo
const metadata = {
  name: "Superior de Cozinha 25d - 60cm",
  category: "cozinha_superior",
  description: "Caixa superior de cozinha com profundidade de 25cm e largura fixa de 60cm",
  dimensions: {
    width: 600,  // mm
    height: 720, // mm
    depth: 250   // mm
