/**
 * Modelo 3D: Superior de Cozinha 35cm profundidade - 30cm largura
 * Categoria: Cozinha - Superior
 * Descrição: Caixa superior de cozinha com profundidade de 35cm e largura fixa de 30cm
 * 
 * Estrutura:
 * - Laterais: 72cm altura x 35cm profundidade
 * - Base: 30cm largura x 35cm profundidade
 * - Topo: 30cm largura x 35cm profundidade
 * - Costas: 72cm altura x 30cm largura
 * 
...
// Metadados do modelo
const metadata = {
  name: "Superior de Cozinha 35d - 30cm",
  category: "cozinha_superior",
  description: "Caixa superior de cozinha com profundidade de 35cm e largura fixa de 30cm",
  dimensions: {
    width: 300,  // mm
    height: 720, // mm
    depth: 350   // mm
