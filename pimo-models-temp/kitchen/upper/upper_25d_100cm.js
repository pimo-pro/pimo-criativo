/**
 * Modelo 3D: Superior de Cozinha 25cm profundidade - 100cm largura
 * Categoria: Cozinha - Superior
 * Descrição: Caixa superior de cozinha com profundidade de 25cm e largura fixa de 100cm
 * 
 * Estrutura:
 * - Laterais: 72cm altura x 25cm profundidade
 * - Base: 100cm largura x 25cm profundidade
 * - Topo: 100cm largura x 25cm profundidade
...
// Metadados do modelo
const metadata = {
  name: "Superior de Cozinha 25d - 100cm",
  category: "cozinha_superior",
  description: "Caixa superior de cozinha com profundidade de 25cm e largura fixa de 100cm",
  dimensions: {
    width: 1000, // mm
    height: 720, // mm
    depth: 250   // mm
