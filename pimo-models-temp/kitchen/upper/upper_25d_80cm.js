/**
 * Modelo 3D: Superior de Cozinha 25cm profundidade - 80cm largura
 * Categoria: Cozinha - Superior
 * Descrição: Caixa superior de cozinha com profundidade de 25cm e largura fixa de 80cm
 * 
 * Estrutura:
 * - Laterais: 72cm altura x 25cm profundidade
 * - Base: 80cm largura x 25cm profundidade
 * - Topo: 80cm largura x 25cm profundidade
 * - Costas: 72cm altura x 80cm largura
 * 
...
// Metadados do modelo
const metadata = {
  name: "Superior de Cozinha 25d - 80cm",
  category: "cozinha_superior",
  description: "Caixa superior de cozinha com profundidade de 25cm e largura fixa de 80cm",
  dimensions: {
    width: 800,  // mm
    height: 720, // mm
    depth: 250   // mm
