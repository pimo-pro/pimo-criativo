/**
 * Modelo 3D: Superior de Cozinha 35cm profundidade - 40cm largura
 * Categoria: Cozinha - Superior
 * Descrição: Caixa superior de cozinha com profundidade de 35cm e largura fixa de 40cm
 * 
 * Estrutura:
 * - Laterais: 72cm altura x 35cm profundidade
 * - Base: 40cm largura x 35cm profundidade
 * - Topo: 40cm largura x 35cm profundidade
 * - Costas: 72cm altura x 40cm largura
 * 
...
// Metadados do modelo
const metadata = {
  name: "Superior de Cozinha 35d - 40cm",
  category: "cozinha_superior",
  description: "Caixa superior de cozinha com profundidade de 35cm e largura fixa de 40cm",
  dimensions: {
    width: 400,  // mm
    height: 720, // mm
    depth: 350   // mm
