/**
 * Modelo 3D: Superior de Cozinha 25cm profundidade - 20cm largura
 * Categoria: Cozinha - Superior
 * Descrição: Caixa superior de cozinha com profundidade de 25cm e largura fixa de 20cm
 * 
 * Estrutura:
 * - Laterais: 72cm altura x 25cm profundidade
 * - Base: 20cm largura x 25cm profundidade
 * - Topo: 20cm largura x 25cm profundidade
...
// Metadados do modelo
const metadata = {
  name: "Superior de Cozinha 25d - 20cm",
  category: "cozinha_superior",
  description: "Caixa superior de cozinha com profundidade de 25cm e largura fixa de 20cm",
  dimensions: {
    width: 200,  // mm
    height: 720, // mm
    depth: 250   // mm
