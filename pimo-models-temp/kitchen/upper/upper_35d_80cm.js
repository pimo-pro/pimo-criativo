/**
 * Modelo 3D: Superior de Cozinha 35cm profundidade - 80cm largura
 * Categoria: Cozinha - Superior
 * Descrição: Caixa superior de cozinha com profundidade de 35cm e largura fixa de 80cm
 * 
 * Estrutura:
 * - Laterais: 72cm altura x 35cm profundidade
 * - Base: 80cm largura x 35cm profundidade
 * - Topo: 80cm largura x 35cm profundidade
...
// Metadados do modelo
const metadata = {
  name: "Superior de Cozinha 35d - 80cm",
  category: "cozinha_superior",
  description: "Caixa superior de cozinha com profundidade de 35cm e largura fixa de 80cm",
  dimensions: {
    width: 800,  // mm
    height: 720, // mm
    depth: 350   // mm
