/**
 * Modelo 3D: Superior de Cozinha 35cm profundidade - 20cm largura
 * Categoria: Cozinha - Superior
 * Descrição: Caixa superior de cozinha com profundidade de 35cm e largura fixa de 20cm
 * 
 * Estrutura:
 * - Laterais: 72cm altura x 35cm profundidade
 * - Base: 20cm largura x 35cm profundidade
 * - Topo: 20cm largura x 35cm profundidade
 * - Costas: 72cm altura x 20cm largura
 * 
...
// Metadados do modelo
const metadata = {
  name: "Superior de Cozinha 35d - 20cm",
  category: "cozinha_superior",
  description: "Caixa superior de cozinha com profundidade de 35cm e largura fixa de 20cm",
  dimensions: {
    width: 200,  // mm
    height: 720, // mm
    depth: 350   // mm
