/**
 * Modelo 3D: Superior de Cozinha 25cm profundidade - 30cm largura
 * Categoria: Cozinha - Superior
 * Descrição: Caixa superior de cozinha com profundidade de 25cm e largura fixa de 30cm
 * 
 * Estrutura:
 * - Laterais: 72cm altura x 25cm profundidade
 * - Base: 30cm largura x 25cm profundidade
 * - Topo: 30cm largura x 25cm profundidade
...
// Metadados do modelo
const metadata = {
  name: "Superior de Cozinha 25d - 30cm",
  category: "cozinha_superior",
  description: "Caixa superior de cozinha com profundidade de 25cm e largura fixa de 30cm",
  dimensions: {
    width: 300,  // mm
    height: 720, // mm
    depth: 250   // mm
