/**
 * Modelo 3D: Superior de Cozinha 35cm profundidade - 50cm largura
 * Categoria: Cozinha - Superior
 * Descrição: Caixa superior de cozinha com profundidade de 35cm e largura fixa de 50cm
 * 
 * Estrutura:
 * - Laterais: 72cm altura x 35cm profundidade
 * - Base: 50cm largura x 35cm profundidade
 * - Topo: 50cm largura x 35cm profundidade
...
// Metadados do modelo
const metadata = {
  name: "Superior de Cozinha 35d - 50cm",
  category: "cozinha_superior",
  description: "Caixa superior de cozinha com profundidade de 35cm e largura fixa de 50cm",
  dimensions: {
    width: 500,  // mm
    height: 720, // mm
    depth: 350   // mm
