/**
 * Modelo 3D: Superior de Cozinha 35cm profundidade - 100cm largura
 * Categoria: Cozinha - Superior
 * Descrição: Caixa superior de cozinha com profundidade de 35cm e largura fixa de 100cm
 * 
 * Estrutura:
 * - Laterais: 72cm altura x 35cm profundidade
 * - Base: 100cm largura x 35cm profundidade
 * - Topo: 100cm largura x 35cm profundidade
 * - Costas: 72cm altura x 100cm largura
 * 
...
// Metadados do modelo
const metadata = {
  name: "Superior de Cozinha 35d - 100cm",
  category: "cozinha_superior",
  description: "Caixa superior de cozinha com profundidade de 35cm e largura fixa de 100cm",
  dimensions: {
    width: 1000, // mm
    height: 720, // mm
    depth: 350   // mm
