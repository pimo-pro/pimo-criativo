/**
 * Modelo 3D: Superior de Cozinha 35cm profundidade - 60cm largura
 * Categoria: Cozinha - Superior
 * Descrição: Caixa superior de cozinha com profundidade de 35cm e largura fixa de 60cm
 * 
 * Estrutura:
 * - Laterais: 72cm altura x 35cm profundidade
 * - Base: 60cm largura x 35cm profundidade
 * - Topo: 60cm largura x 35cm profundidade
 * - Costas: 72cm altura x 60cm largura
 * 
...
// Metadados do modelo
const metadata = {
  name: "Superior de Cozinha 35d - 60cm",
  category: "cozinha_superior",
  description: "Caixa superior de cozinha com profundidade de 35cm e largura fixa de 60cm",
  dimensions: {
    width: 600,  // mm
    height: 720, // mm
    depth: 350   // mm
