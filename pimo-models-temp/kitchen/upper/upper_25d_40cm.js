/**
 * Modelo 3D: Superior de Cozinha 25cm profundidade - 40cm largura
 * Categoria: Cozinha - Superior
 * Descrição: Caixa superior de cozinha com profundidade de 25cm e largura fixa de 40cm
 * 
 * Estrutura:
 * - Laterais: 72cm altura x 25cm profundidade
 * - Base: 40cm largura x 25cm profundidade
 * - Topo: 40cm largura x 25cm profundidade
...
// Metadados do modelo
const metadata = {
  name: "Superior de Cozinha 25d - 40cm",
  category: "cozinha_superior",
  description: "Caixa superior de cozinha com profundidade de 25cm e largura fixa de 40cm",
  dimensions: {
    width: 400,  // mm
    height: 720, // mm
    depth: 250   // mm
