/**
 * Modelo 3D: Superior de Cozinha 35cm profundidade - 70cm largura
 * Categoria: Cozinha - Superior
 * Descrição: Caixa superior de cozinha com profundidade de 35cm e largura fixa de 70cm
 * 
 * Estrutura:
 * - Laterais: 72cm altura x 35cm profundidade
 * - Base: 70cm largura x 35cm profundidade
 * - Topo: 70cm largura x 35cm profundidade
 * - Costas: 72cm altura x 70cm largura
 * 
...
// Metadados do modelo
const metadata = {
  name: "Superior de Cozinha 35d - 70cm",
  category: "cozinha_superior",
  description: "Caixa superior de cozinha com profundidade de 35cm e largura fixa de 70cm",
  dimensions: {
    width: 700,  // mm
    height: 720, // mm
    depth: 350   // mm
