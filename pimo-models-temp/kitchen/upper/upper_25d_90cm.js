/**
 * Modelo 3D: Superior de Cozinha 25cm profundidade - 90cm largura
 * Categoria: Cozinha - Superior
 * Descrição: Caixa superior de cozinha com profundidade de 25cm e largura fixa de 90cm
 * 
 * Estrutura:
 * - Laterais: 72cm altura x 25cm profundidade
 * - Base: 90cm largura x 25cm profundidade
 * - Topo: 90cm largura x 25cm profundidade
...
// Metadados do modelo
const metadata = {
  name: "Superior de Cozinha 25d - 90cm",
  category: "cozinha_superior",
  description: "Caixa superior de cozinha com profundidade de 25cm e largura fixa de 90cm",
  dimensions: {
    width: 900,  // mm
    height: 720, // mm
    depth: 250   // mm
