/**
 * Modelo 3D: Base de Cozinha 20cm
 * Categoria: Cozinha - Base
 * Descrição: Caixa base de cozinha com largura fixa de 20cm
 * 
 * Estrutura:
 * - Laterais: 85cm altura x 55cm profundidade
 * - Base: 20cm largura x 55cm profundidade
 * - Topo: 20cm largura x 55cm profundidade
 * - Costas: 85cm altura x 20cm largura
 * 
...
// Metadados do modelo
const metadata = {
  name: "Base de Cozinha 20cm",
  category: "cozinha_base",
  description: "Caixa base de cozinha com largura fixa de 20cm",
  dimensions: {
    width: 200,  // mm
    height: 850, // mm
    depth: 550   // mm
