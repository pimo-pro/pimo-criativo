/**
 * Modelo 3D: Base de Cozinha 40cm
 * Categoria: Cozinha - Base
 * Descrição: Caixa base de cozinha com largura fixa de 40cm
 * 
 * Estrutura:
 * - Laterais: 85cm altura x 55cm profundidade
 * - Base: 40cm largura x 55cm profundidade
 * - Topo: 40cm largura x 55cm profundidade
 * - Costas: 85cm altura x 40cm largura
 * 
...
// Metadados do modelo
const metadata = {
  name: "Base de Cozinha 40cm",
  category: "cozinha_base",
  description: "Caixa base de cozinha com largura fixa de 40cm",
  dimensions: {
    width: 400,  // mm
    height: 850, // mm
    depth: 550   // mm
