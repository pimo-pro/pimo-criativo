/**
 * Modelo 3D: Base de Cozinha 50cm
 * Categoria: Cozinha - Base
 * Descrição: Caixa base de cozinha com largura fixa de 50cm
 * 
 * Estrutura:
 * - Laterais: 85cm altura x 55cm profundidade
 * - Base: 50cm largura x 55cm profundidade
 * - Topo: 50cm largura x 55cm profundidade
 * - Costas: 85cm altura x 50cm largura
 * 
...
// Metadados do modelo
const metadata = {
  name: "Base de Cozinha 50cm",
  category: "cozinha_base",
  description: "Caixa base de cozinha com largura fixa de 50cm",
  dimensions: {
    width: 500,  // mm
    height: 850, // mm
    depth: 550   // mm
