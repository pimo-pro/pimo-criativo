/**
 * Modelo 3D: Guarda-roupa Superior 100cm
 * Categoria: Guarda-roupa - Superior
 * Descrição: Caixa guarda-roupa superior com largura fixa de 100cm
 * 
 * Estrutura:
 * - Laterais: 80cm altura x 55cm profundidade
 * - Base: 100cm largura x 55cm profundidade
 * - Topo: 100cm largura x 55cm profundidade
 * - Costas: 80cm altura x 100cm largura
 * 
...
// Metadados do modelo
const metadata = {
  name: "Guarda-roupa Superior 100cm",
  category: "wardrobe_upper",
  description: "Caixa guarda-roupa superior com largura fixa de 100cm",
  dimensions: {
    width: 1000, // mm
    height: 800, // mm
    depth: 550   // mm
  ...
  rules: {
    height: { min: 600, max: 1000 },    // mm
    depth: { min: 500, max: 600 },      // mm
    width: { min: 1000, max: 1000 }     // mm (fixo)
  }
};

/**
 * Gera as peças da caixa guarda-roupa superior
