/**
 * Modelo 3D: Guarda-roupa Superior 60cm
 * Categoria: Guarda-roupa - Superior
 * Descrição: Caixa guarda-roupa superior com largura fixa de 60cm
 * 
 * Estrutura:
 * - Laterais: 80cm altura x 55cm profundidade
 * - Base: 60cm largura x 55cm profundidade
 * - Topo: 60cm largura x 55cm profundidade
 * - Costas: 80cm altura x 60cm largura
 * 
...
// Metadados do modelo
const metadata = {
  name: "Guarda-roupa Superior 60cm",
  category: "wardrobe_upper",
  description: "Caixa guarda-roupa superior com largura fixa de 60cm",
  dimensions: {
    width: 600,  // mm
    height: 800, // mm
    depth: 550   // mm
