/**
 * Modelo 3D: Guarda-roupa Superior 70cm
 * Categoria: Guarda-roupa - Superior
 * Descrição: Caixa guarda-roupa superior com largura fixa de 70cm
 * 
 * Estrutura:
 * - Laterais: 80cm altura x 55cm profundidade
 * - Base: 70cm largura x 55cm profundidade
 * - Topo: 70cm largura x 55cm profundidade
 * - Costas: 80cm altura x 70cm largura
 * 
...
// Metadados do modelo
const metadata = {
  name: "Guarda-roupa Superior 70cm",
  category: "wardrobe_upper",
  description: "Caixa guarda-roupa superior com largura fixa de 70cm",
  dimensions: {
    width: 700,  // mm
    height: 800, // mm
    depth: 550   // mm
