/**
 * Modelo 3D: Guarda-roupa Superior 80cm
 * Categoria: Guarda-roupa - Superior
 * Descrição: Caixa guarda-roupa superior com largura fixa de 80cm
 * 
 * Estrutura:
 * - Laterais: 80cm altura x 55cm profundidade
 * - Base: 80cm largura x 55cm profundidade
 * - Topo: 80cm largura x 55cm profundidade
 * - Costas: 80cm altura x 80cm largura
 * 
...
// Metadados do modelo
const metadata = {
  name: "Guarda-roupa Superior 80cm",
  category: "wardrobe_upper",
  description: "Caixa guarda-roupa superior com largura fixa de 80cm",
  dimensions: {
    width: 800,  // mm
    height: 800, // mm
    depth: 550   // mm
