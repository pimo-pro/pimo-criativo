/**
 * Modelo 3D: Guarda-roupa Superior 90cm
 * Categoria: Guarda-roupa - Superior
 * Descrição: Caixa guarda-roupa superior com largura fixa de 90cm
 * 
 * Estrutura:
 * - Laterais: 80cm altura x 55cm profundidade
 * - Base: 90cm largura x 55cm profundidade
 * - Topo: 90cm largura x 55cm profundidade
 * - Costas: 80cm altura x 90cm largura
 * 
...
// Metadados do modelo
const metadata = {
  name: "Guarda-roupa Superior 90cm",
  category: "wardrobe_upper",
  description: "Caixa guarda-roupa superior com largura fixa de 90cm",
  dimensions: {
    width: 900,  // mm
    height: 800, // mm
    depth: 550   // mm
