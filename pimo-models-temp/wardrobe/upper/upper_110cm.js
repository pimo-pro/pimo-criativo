/**
 * Modelo 3D: Guarda-roupa Superior 110cm
 * Categoria: Guarda-roupa - Superior
 * Descrição: Caixa guarda-roupa superior com largura fixa de 110cm
 * 
 * Estrutura:
 * - Laterais: 80cm altura x 55cm profundidade
 * - Base: 110cm largura x 55cm profundidade
 * - Topo: 110cm largura x 55cm profundidade
 * - Costas: 80cm altura x 110cm largura
 * 
...
// Metadados do modelo
const metadata = {
  name: "Guarda-roupa Superior 110cm",
  category: "wardrobe_upper",
  description: "Caixa guarda-roupa superior com largura fixa de 110cm",
  dimensions: {
    width: 1100, // mm
    height: 800, // mm
    depth: 550   // mm
  ...
  rules: {
    ...
    width: { min: 1100, max: 1100 }     // mm (fixo)
  }
};
